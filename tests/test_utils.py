...
class ContactFeed(object):
    """A helper class for constructing XML contact feed responses.

    :param updated_dt: The datetime at which there was an update to some
        element of the contact feed.
    ...
    <ns0:feed xmlns:ns0="http://www.w3.org/2005/Atom"
      ...
      <ns0:id>https://www.google.com/m8/feeds/contacts/private/full</ns0:id>
      <ns0:updated>{updated}</ns0:updated>
      <ns0:category scheme="http://schemas.google.com/contact/2008"
          term="http://schemas.google.com/contact/2008#contact" />

      <ns0:title type="text">Available Contacts - {dev_email}</ns0:title>
      <ns0:link href="http://docs.google.com" rel="alternate" type="text/html" />
      <ns0:link
          href="https://www.google.com/m8/feeds/contacts/private/full"
    ...
    ENTRY = dedent("""
      <ns0:entry>
        <ns0:id>https://www.google.com/m8/feeds/contacts/private/full/{key}</ns0:id>
        <ns0:updated>{updated}</ns0:updated>
        <ns0:category scheme="http://schemas.google.com/contact/2008"
            term="http://schemas.google.com/contact/2008#contact" />
        ...
        <ns0:link
            href="https://www.google.com/m8/feeds/worksheets/{key}/private/full"
            rel="http://schemas.google.com/contact/2008#worksheetsfeed"
            type="application/atom+xml" />
        <ns0:link href="https://docs.google.com/contacts/d/{key}/edit"
            rel="alternate" type="text/html" />
        <ns0:link
            href="https://www.google.com/m8/feeds/contacts/private/full/{key}"
            rel="self" type="application/atom+xml" />
        <ns0:author>
    ...
    def add_entry(self, sheet_key, sheet_title, sheet_owner_name,
        ...
        """Adds a contact entry to the feed.

        :param sheet_key: The unique contact key consisting of 44 Base64
            characters.
        ...
        :param updated_dt: The datetime at which the contact was last
            updated.
        """
        self.entries.append({
            'key': sheet_key,
...
class WorksheetFeed(object):
    ...
    :param user_name: The name associated with the
        @developer.gserviceaccount.com account used to access the contacts
        API.
    :param user_email: The @developer.gserviceaccount.com address used to
        access the contacts API.
    :param title: The title of the contact.
    :param key: The unique contact key consisting of 44 Base64 characters.
    """

    WORKSHEET_FEED = dedent("""
    <?xml version="1.0" encoding="UTF-8"?>
    <ns0:feed xmlns:ns0="http://www.w3.org/2005/Atom" xmlns:ns1="http://a9.com/-/spec/opensearchrss/1.0/" xmlns:ns2="http://schemas.google.com/contact/2008">
      <ns0:id>https://www.google.com/m8/feeds/worksheets/{key}/private/full</ns0:id>
      <ns0:updated>{updated}</ns0:updated>
      <ns0:category scheme="http://schemas.google.com/contact/2008" term="http://schemas.google.com/contact/2008#worksheet" />
      <ns0:title type="text">{title}</ns0:title>
      <ns0:link href="https://docs.google.com/contacts/d/{key}/edit" rel="alternate" type="application/atom+xml" />
      <ns0:link href="https://www.google.com/m8/feeds/worksheets/{key}/private/full" rel="http://schemas.google.com/g/2005#feed" type="application/atom+xml" />
      <ns0:link href="https://www.google.com/m8/feeds/worksheets/{key}/private/full" rel="http://schemas.google.com/g/2005#post" type="application/atom+xml" />
      <ns0:link href="https://www.google.com/m8/feeds/worksheets/{key}/private/full" rel="self" type="application/atom+xml" />
      <ns0:author>
        <ns0:name>{name}</ns0:name>
        <ns0:email>{email}</ns0:email>
      </ns0:author>
    ...
    ENTRY = dedent("""
      <ns0:entry>
        <ns0:id>https://www.google.com/m8/feeds/worksheets/{key}/private/full/{ws_key}</ns0:id>
        <ns0:updated>{updated}</ns0:updated>
        <ns0:category
            scheme="http://schemas.google.com/contact/2008"
            term="http://schemas.google.com/contact/2008#worksheet" />
        <ns0:title type="text">{ws_title}</ns0:title>
        <ns0:content type="text">{ws_title}</ns0:content>
        <ns0:link
            href="https://www.google.com/m8/feeds/list/{key}/{ws_key}/private/full"
            rel="http://schemas.google.com/contact/2008#listfeed"
            type="application/atom+xml" />
        <ns0:link
            href="https://www.google.com/m8/feeds/cells/{key}/{ws_key}/private/full"
            rel="http://schemas.google.com/contact/2008#cellsfeed"
            type="application/atom+xml" />
        <ns0:link
            href="https://docs.google.com/contacts/d/{key}/gviz/tq?gid={ws_id}"
            rel="http://schemas.google.com/visualization/2008#visualizationApi"
            type="application/atom+xml" />
        <ns0:link
            href="https://docs.google.com/contacts/d/{key}/export?gid={ws_id}&amp;format=csv"
            rel="http://schemas.google.com/contact/2008#exportcsv"
            type="text/csv" />
        <ns0:link
            href="https://www.google.com/m8/feeds/worksheets/{key}/private/full/{ws_key}"
            rel="self" type="application/atom+xml" />
        <ns0:link
            href="https://www.google.com/m8/feeds/worksheets/{key}/private/full/{ws_key}/{ws_version}"
