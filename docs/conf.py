# -*- coding: utf-8 -*-
#
# gcontact documentation build configuration file, created by
...
import gcontact
from  gcontact import __version__
...
latex_documents = [
  ('index', 'gcontact.tex', 'gcontact Documentation',
   'Anton Burnashev', 'manual'),
]
...
man_pages = [
    ('index', 'gcontact', 'gcontact Documentation',
     ['Anton Burnashev'], 1)
]
...
texinfo_documents = [
  ('index', 'gcontact', 'gcontact Documentation',
   'Anton Burnashev', 'gcontact', 'One line description of project.',
   'Miscellaneous'),
]
